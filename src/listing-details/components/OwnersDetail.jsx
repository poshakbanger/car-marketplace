...
function OwnersDetail({carDetail}) {
  ...
  return (
    <div className='p-10 border rounded-xl shadow-md mt-7'>
        ...
        <img src={carDetail?.userImageUrl} alt="" className='w-[70px] h-[70px] rounded-full'/>
        <h2 className='mt-2 font-bold text-xl'>{carDetail?.userName}</h2>
        <h2 className='mt-2 text-gray-500'>{carDetail?.createdBy}</h2>

        <Button className="w-full mt-6"onClick={OnMessageOwnerButtonClick}>Message Owner</Button>
